...
addpath('/Users/luisciria/Desktop/CuttingEEG-Donostia HEP Tutorial/heplab/toolboxes/ecglab/functions'); %ecglab
...
%% load the EEG file 'ENT_1_raw.set'
load('ENT_1_raw.mat');
...
% prepare ECG .mat file for R or T peaks detection in ecglab
% the variables have to be called 'ecg' and 'fs'
% ecg must be an Nx1 vector
ecg = ecg';
fs  = data_eeg.fsample; % sampling frequency

save ('ENT_1_ecg.mat','ecg','fs');

%% Next step ---> load the ECG .mat file called ENT_1_sampleECG.mat to ecglabRR
